...
// the camera struct used in compute shader
...
public:
    ...
    RtCameraCompute get_camera_compute()
    {
        RtCameraCompute cam_comp;
        cam_comp.lookfrom = lookfrom;
        cam_comp.pixel_00 = pixel_00;
        cam_comp.pixel_delta_u = pixel_delta_u;
        cam_comp.pixel_delta_v = pixel_delta_v;
        cam_comp.defocus_disk_u = defocus_disk_u;
        cam_comp.defocus_disk_v = defocus_disk_v;
        cam_comp.max_depth = max_depth;
        cam_comp.samples_per_pixel = samples_per_pixel;
        return cam_comp;
    }
